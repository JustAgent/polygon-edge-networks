...
contract TOKENNAME is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(ADDRESS); 
    address payable public developmentAddress = payable(ADDRESS); 
    address payable public charityAddress = payable(ADDRESS); 
    address payable public vaultRewardAddress = payable(ADDRESS); 
